...
Philbert is an advanced, responsive dashboard UI kit built using Bootstrap, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.

It includes 7 different layout with 6 different menu styles, with one special e-commerce layout, more than 100 HTML files and lots of widgets and custom made reusable components to help you develop your next application.
...
Installation instructions for local development(Optional)
